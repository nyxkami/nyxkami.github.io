                ...
                >
                  <div className="relative p-6 md:p-3">
                    <div className="search-dialog">
                      ...
                      >
                        <p>Introduzca palabras clave para buscar publicaciones del blog</p>
                        <p className="mt-1 text-xs">
                          Presiona <kbd className="rounded bg-black/10 px-1.5 py-0.5 font-mono dark:bg-white/10">ESC</kbd> para cerrar
                        </p>
                      </div>
                    ...
                    <div className="absolute inset-x-0 bottom-0 z-10 flex items-center justify-center gap-4 bg-gradient-start px-4 pt-1 pb-4 text-black/50 text-xs dark:border-white/10 dark:text-white/50">
                      ...
                      <span>
                        <kbd className="kbd">Enter</kbd> Abrir
                      </span>
                      <span>
